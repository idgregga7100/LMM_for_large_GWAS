...
date: "2024-04-17"
---
arg parsing from an rmd! thank you stackoverflow:
add params to header, params argument when rendering from command line like this:
Rscript -e "rmarkdown::render(\"file.Rmd\", params = list(myName = \"abcd\"))"
unfortunately the arguments would be. so many file names. it would be eight file names
