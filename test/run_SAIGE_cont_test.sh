...
# to run: nohup bash run_SAIGE_cont_test.sh -i 100simu-genos -p simu_continous.phen -c TRAIT -s IID -o 100simu-genos_saige_qt -t 2 > nohup_SAIGE_cont_test.out &
...
#out_prefix=100simu-genos_saige_qt
