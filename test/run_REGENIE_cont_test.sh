...
# to run: nohup bash run_REGENIE_cont_test.sh -i /home/igregga/LMM_files/1250simu-genos -p simu_continous.phen -o 1250simu-genos_regenie_qt -t 2 > nohup_REGENIE_cont_test.out &
...
#out_prefix=100simu-genos_regenie_qt
