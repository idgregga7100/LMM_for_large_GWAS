...
--phenoFile /home/igregga/LMM_files/phenos/simu_categorical-01na.phen \
--bt \
--bsize 1000 \
--out /home/igregga/regenie-out/${f}categorical-fit \
--force-step1 \
--lowmem \
...
--bed /home/igregga/LMM_files/${f}simu-genos \
--pred /home/igregga/regenie-out/${f}categorical-fit_pred.list \
--phenoFile /home/igregga/LMM_files/phenos/simu_categorical-01na.phen \
--bt \
--bsize 1000 \
--out /home/igregga/regenie-out/${f}categorical-test \
--threads 2
done
...
#to run: nohup /home/igregga/LMM_for_large_GWAS/run_REGENIE-binary.sh > /home/igregga/regenie-out/regeniecat.log &